...
const CheckoutPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const getAvailableQuantity = async (productSizeId) => {
      try {
        const response = await axios.get(`https://storebackend-2c94.onrender.com/api/product_size/${productSizeId}`);
    ...
    const updateAvailableQuantity = async (productSizeId, newQuantity) => {
      try {
        await axios.put(`https://storebackend-2c94.onrender.com/api/product_size/${productSizeId}`, {
    ...
    try {
      ...
      const response = await axios.post('https://storebackend-2c94.onrender.com/api/orders', orderData);
